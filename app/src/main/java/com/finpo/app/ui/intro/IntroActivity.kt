...
class IntroActivity : BaseActivity<ActivityIntroBinding>(R.layout.activity_intro) {
    ...
    override fun init() {
        ...
        initViewPager()
        observeRegisterSuccessEvent()
        observeRegisterErrorToastEvent()
        observeIntroMainButtonClickEvent()
        observeGoToMainActivityEvent()
    }

    private fun observeGoToMainActivityEvent() {
    ...
    private fun observeIntroMainButtonClickEvent() {
    ...
    private fun observeRegisterErrorToastEvent() {
        viewModel.registerErrorToastEvent.observe(this) {
            shortShowToast("회원가입 실패!")
        }
    }

    private fun observeRegisterSuccessEvent() {
