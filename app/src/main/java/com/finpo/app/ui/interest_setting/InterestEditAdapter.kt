...
import com.finpo.app.databinding.ItemRecyclerEditInterestBinding
...
class InterestEditAdapter(val viewModel: InterestSettingViewModel) :
    ListAdapter<CategoryChildFormat, InterestEditAdapter.FilterViewHolder>(diffUtil) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FilterViewHolder {
        return FilterViewHolder(
            ItemRecyclerEditInterestBinding.inflate(
    ...
    inner class FilterViewHolder(private val binding: ItemRecyclerEditInterestBinding) :
        ...
        private fun initRecyclerView(data: CategoryChildFormat) {
            val filterDetailAdapter = InterestEditDetailAdapter(viewModel)
