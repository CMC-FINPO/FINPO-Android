...
class BookmarkAdapter(val viewModel: MyPageViewModel)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when(viewType) {
            CONTENT -> {
                val binding = ItemRecyclerMyPageBookmarkBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class PolicyHolder(private val binding: ItemRecyclerMyPageBookmarkBinding) :
        RecyclerView.ViewHolder(binding.root) {
